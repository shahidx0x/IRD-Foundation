        ...
        <div className="bg-white rounded-3xl px-4 dark:bg-dark-bg lg:h-[calc(93vh)] xl:h-[94vh] 2xl:h-[93vh] 3xl:h-[93vh] overflow-y-auto overflow-x-hidden pb-16">
          ...
          <a href="/">
            ...
            >
              ...
              <div className="p-2 flex flex-row justify-center items-center">
                <div className="bg-icon-bg dark:bg-dark-bg-dark flex p-2 rounded-full bg-[#E8F0F5] items-center h-10 w-10 justify-center">
                  <img
          ...
          <a href="/alldua">
            ...
            >
              <div className="w-1 rounded-tl-lg rounded-bl-lg "></div>
              <div className="p-2 flex flex-row justify-center items-center">
                <div className="bg-icon-bg dark:bg-dark-bg-dark flex p-2 rounded-full items-center h-10 w-10 justify-center bg-[#E8F0F5]">
                  <img
          ...
          <div>
            <div className="pt-6 xl:pt-16 2xl:pt-16 3xl:pt-24 pb-2 text-center">
              <a href="/support">
                <div className="pt-7 mb-10 xl:mb-16 2xl:mb-16 3xl:mb-24 container bg-[#1FA45B] flex justify-center items-center px-7 py-3 rounded-xl">
                  <a href="/">
                    <svg
                      width="34"
                      height="34"
